...
# Servicios adicionales (referencia us-east-1, aprox. 2024)
PRECIO_ALB_MENSUAL = 22.50
PRECIO_CLOUDFRONT_POR_GB = 0.085
PRECIO_ROUTE53_HOSTED_ZONE_MENSUAL = 0.50
PRECIO_FARGATE_VCPU_HORA = 0.04048
PRECIO_FARGATE_GB_HORA = 0.004445
PRECIO_ECS_CLUSTER_REF_MENSUAL = 0.0
PRECIO_COGNITO_POR_MAU = 0.0055
PRECIO_CLOUDWATCH_LOG_POR_GB = 0.50
PRECIO_NAT_GATEWAY_MENSUAL = 32.40
FECHA_PRECIOS_ESTATICOS = '2024 (referencia us-east-1)'
